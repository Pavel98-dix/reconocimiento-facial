...
public class RegistroIIActivity extends AppCompatActivity {
    ...
    private boolean validatePadecimiento() {
        ...
        if (usernameInput.isEmpty()) {
            textInputPadecimiento.setError("El campo no puede estar vacío.");
            return false;
        } else if (usernameInput.length() > 30) {
            textInputPadecimiento.setError("Nombre de usuario demasiado largo");
            return false;
        } else if (!TEXT_PATTERN.matcher(usernameInput).matches()) {
            textInputPadecimiento.setError("Por favor, introduce un Nombre valido");
            return false;
        }else {
            textInputPadecimiento.setError(null);
            return true;
        }
    }
    private boolean validateMedicamento() {
        ...
        if (usernameInput.isEmpty()) {
            textInputMedicamento.setError("El campo no puede estar vacío.");
            return false;
        } else if (usernameInput.length() > 30) {
            textInputMedicamento.setError("Nombre de usuario demasiado largo");
            return false;
        } else if (!TEXT_PATTERN.matcher(usernameInput).matches()) {
            textInputMedicamento.setError("Por favor, introduce un Medicamento valido");
            return false;
        }else {
            textInputMedicamento.setError(null);
            return true;
        }
    }
    private boolean validateIndicaciones() {
        ...
        if (usernameInput.isEmpty()) {
            textInputIndicaciones.setError("El campo no puede estar vacío.");
            return false;
        } else if (usernameInput.length() > 30) {
            textInputIndicaciones.setError("Nombre de usuario demasiado largo");
            return false;
        } else {
            textInputIndicaciones.setError(null);
            return true;
        }
    }
    private boolean validateClinica() {
        ...
        if (usernameInput.isEmpty()) {
            textInputClinica.setError("El campo no puede estar vacío.");
            return false;
        } else if (usernameInput.length() > 30) {
            textInputClinica.setError("Nombre de usuario demasiado largo");
            return false;
        } else if (!TEXT_PATTERN.matcher(usernameInput).matches()) {
            textInputClinica.setError("Por favor, introduce un Medicamento valido");
            return false;
        }else {
            textInputClinica.setError(null);
            return true;
        }
    }
